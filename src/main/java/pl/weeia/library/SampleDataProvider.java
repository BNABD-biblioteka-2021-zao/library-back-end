...
public class SampleDataProvider implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<BookCopy> copies = copyRepository.saveAll(Arrays.asList(
                new BookCopy("7894161", LocalDate.now(), 255L, "KEN", books.get(0), CopyStatus.available ),
                new BookCopy("9111611", LocalDate.now().minusDays(20), 125L, "KEN", books.get(1), CopyStatus.available ),
                new BookCopy("39208590", LocalDate.now().minusWeeks(102), 608L, "Prószyński Media", books.get(2), CopyStatus.available ),
                new BookCopy("16838581", LocalDate.now().minusWeeks(410), 352L, "Wydawnictwo Albatros", books.get(3), CopyStatus.available ),
                new BookCopy("33003221", LocalDate.now().minusWeeks(152), 1104L, "Wydawnictwo Albatros", books.get(4), CopyStatus.available ),
                new BookCopy("38795275", LocalDate.now().minusWeeks(140), 432L, "Wydawnictwo Albatros", books.get(5), CopyStatus.available ),
                new BookCopy("38759949", LocalDate.now().minusWeeks(130), 152L, "Egmont Polska Sp. z o.o.", books.get(6), CopyStatus.available ),
                new BookCopy("33979823", LocalDate.now().minusWeeks(130), 108L, "Egmont Polska Sp. z o.o.", books.get(7), CopyStatus.available ),
                new BookCopy("34814833", LocalDate.now().minusWeeks(105), 784L, "Dom Wydawniczy Rebis", books.get(8), CopyStatus.available ),
                new BookCopy("34919538", LocalDate.now().minusWeeks(210), 304L, "Dom Wydawniczy Rebis", books.get(9), CopyStatus.available ),
                new BookCopy("34977163", LocalDate.now().minusWeeks(160), 576L, "Dom Wydawniczy Rebis", books.get(10), CopyStatus.available ),
                new BookCopy("35734550", LocalDate.now().minusWeeks(410), 536L, "Dom Wydawniczy Rebis", books.get(11), CopyStatus.available ),
                new BookCopy("36114061", LocalDate.now().minusWeeks(110), 624L, "Dom Wydawniczy Rebis", books.get(12), CopyStatus.available ),
                new BookCopy("36287468", LocalDate.now().minusWeeks(178), 624L, "Dom Wydawniczy Rebis", books.get(13), CopyStatus.available ),
                new BookCopy("18036930", LocalDate.now().minusWeeks(165), 592L, "Wydawnictwo Insignis", books.get(14), CopyStatus.available ),
                new BookCopy("37064129", LocalDate.now().minusWeeks(195), 0L, "Wydawnictwo Insignis", books.get(15), CopyStatus.available ),
                new BookCopy("65060070", LocalDate.now().minusWeeks(210), 264L, "Wydawnictwo Dolnośląskie", books.get(16), CopyStatus.available ),
                new BookCopy("14197932", LocalDate.now().minusWeeks(310), 224L, "Wydawnictwo Dolnośląskie", books.get(17), CopyStatus.available ),
                new BookCopy("65919972", LocalDate.now().minusWeeks(342), 216L, "Wydawnictwo Dolnośląskie", books.get(18), CopyStatus.available ),
                new BookCopy("36673087", LocalDate.now().minusWeeks(251), 44L, "Egmont Polska Sp. z o.o.", books.get(19), CopyStatus.available ),
                new BookCopy("35319344", LocalDate.now().minusWeeks(125), 44L, "Egmont Polska Sp. z o.o.", books.get(20), CopyStatus.available ),
                new BookCopy("35120858", LocalDate.now().minusWeeks(354), 44L, "Egmont Polska Sp. z o.o.", books.get(21), CopyStatus.available ),
                new BookCopy("36857661", LocalDate.now().minusWeeks(334), 44L, "Egmont Polska Sp. z o.o.", books.get(22), CopyStatus.available ),
                new BookCopy("38082238", LocalDate.now().minusWeeks(244), 536L, "Wydawnictwo Bellona", books.get(23), CopyStatus.available ),
                new BookCopy("37248604", LocalDate.now().minusWeeks(574), 288L, "Wydawnictwo RM", books.get(24), CopyStatus.available ),
                new BookCopy("68492830", LocalDate.now().minusWeeks(324), 304L, "Wydawnictwa Debit", books.get(25), CopyStatus.available ),
                //###############################################################################################
                new BookCopy("7894161", LocalDate.now(), 255L, "KEN", books.get(0), CopyStatus.available ),
                new BookCopy("9111611", LocalDate.now().minusDays(20), 125L, "KEN", books.get(1), CopyStatus.available ),
                new BookCopy("39208590", LocalDate.now().minusWeeks(102), 608L, "Prószyński Media", books.get(2), CopyStatus.available ),
